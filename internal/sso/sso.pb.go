...
type AuthRequest struct {
        ...
        // Types that are assignable to AuthField:
        //
...
func (m *AuthRequest) GetAuthField() isAuthRequest_AuthField {
        if m != nil {
                return m.AuthField
        }
        return nil
...
func (x *AuthRequest) GetUsername() string {
        if x, ok := x.GetAuthField().(*AuthRequest_Username); ok {
                return x.Username
        }
        return ""
}
...
func (x *AuthRequest) GetEmail() string {
        if x, ok := x.GetAuthField().(*AuthRequest_Email); ok {
                return x.Email
        }
        return ""
}
...
func file_proto_sso_proto_init() {
        ...
        file_proto_sso_proto_msgTypes[2].OneofWrappers = []interface{}{
